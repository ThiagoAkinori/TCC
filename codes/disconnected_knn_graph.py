                ...
                for metric in metric_list:
                        ...
                        for perc_labeled in perc_labels:
                                ...
                                for i in range(n):
                                        ...
                                        print('[INFO] Choosing connected component')
                                        ...
                                        #img_name = dataset+'/'+metric+'/'+str(int(perc_labeled*100))+'_disconnected_'+metric+'_'+dataset
                                        #try:

                                        #        print_graph(knn_graph_obj, node_toget_labels, img_name)
                                        #except:
                                        #        print('Error: in '+algorithm+' '+dataset+' '+str(int(perc_labeled*100)))
